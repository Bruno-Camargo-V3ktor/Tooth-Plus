        ...
        App::new()
            ...
            .service(
                web::scope("/api")
                    ...
                    .service(routes::clinics::get_whatsapp_status)
                    .service(routes::clinics::get_whatsapp_qr)
                    .service(routes::clinics::disconnect_whatsapp)
                    .service(routes::clinics::send_test_whatsapp)
                    ...
                    .service(routes::finance::register_transaction_payment)
                    ...
                    .service(routes::patients::request_anamnesis_signature)
                    ...
                    .service(routes::clinics::list_treatment_templates)
                    .service(routes::clinics::create_treatment_template)
                    .service(routes::clinics::update_treatment_template)
                    .service(routes::clinics::delete_treatment_template)
                    .service(routes::patients::list_patient_plans)
                    .service(routes::patients::create_treatment_plan)
                    .service(routes::patients::update_treatment_plan)
                    .service(routes::patients::update_treatment_plan_status)
                    .service(routes::patients::pay_treatment_plan)
                    .service(routes::patients::delete_treatment_plan)
